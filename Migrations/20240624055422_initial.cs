        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    url8 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Img8 = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    url9 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Img9 = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
